...
def action_client():
    ...
    while(i<NF):
        ...
        temp.pose.position.x = RLeg_odom.pose.pose.position.x + 0.15*i 
        ...
        temp.pose.position.x = LLeg_odom.pose.pose.position.x + 0.15*i 
...
if __name__ == '__main__':
    try:
        ...
        rospy.init_node('r')
        rospy.Subscriber("/atlas_raisim_ros/LLeg/odom", Odometry, LLegcallback)
        rospy.Subscriber("/atlas_raisim_ros/RLeg/odom", Odometry, RLegcallback)
        rospy.Subscriber("/atlas_raisim_ros/CoM", Odometry, CoMcallback)
        rospy.Subscriber("/atlas_raisim_ros/ZMP", PointStamped, ZMPcallback)
